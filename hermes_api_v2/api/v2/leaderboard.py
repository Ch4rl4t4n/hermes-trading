...
from hermes_api_v2.dependencies import get_current_user, get_redis_client
...
async def get_leaderboard(
    ...
    if normalized is None:
        raise HTTPException(
            ...
            detail="period musí byť 7d|30d|all",
        )
    ...
    subscribed_ids = {str(row["agent_id"]) for row in subscribed_rows}
